...
case object release {
  ...
  //   val local = Data.Local(localFolder)
  ...
  //       mirrorFile(
  //         url = Data.input.url()
  //         gzFile = local.idMappingTSVGZ,
  //         file = local.idMappingTSV,
  //         s3Obj = s3.idMappingTSV(version)
  //       ).flatMap { idMappingsS3 =>
  //         // FASTA
  //         mirrorFile(
  //           url = input.speciesSpecificFASTAGZ(version),
  //           gzFile = local.speciesSpecificFASTAGZ,
  //           file = local.speciesSpecificFASTA,
  //           s3Obj = s3.speciesSpecificFASTA(version)
  //         ).map { fastaS3 =>
