...
case object RNAType {
  ...
  case object autocataliticallySplicedIntron  extends RNAType("autocatalytically_spliced_intron")
  ...
  val from: String => Option[RNAType] = 
    _ match {
      ...
      case autocataliticallySplicedIntron.name  => Some(autocataliticallySplicedIntron)
