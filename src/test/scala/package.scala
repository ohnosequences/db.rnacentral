...
package object test {
  ...
  /**
    ...
    */
  private[test] def getCheckedFile(s3Obj: S3Object, file: File) =
  ...
  /**
    ...
    */
  private[test] def paranoidPutFile(file: File, s3Obj: S3Object) =
    request.paranoidPutFile(s3Client)(file, s3Obj, partSize5MiB)(
      rnacentral.data.hashingFunction
    )

  private[test] def getCheckedFileIfDifferent(s3Obj: S3Object, file: File) =
